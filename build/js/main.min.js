...
/* harmony import */ var _modules_modals_link_scroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/modals/link-scroll */ "./js/modules/modals/link-scroll.js");
/* harmony import */ var _modules_modals_link_scroll__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_modals_link_scroll__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _modules_modals_yb_video__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/modals/yb-video */ "./js/modules/modals/yb-video.js");
/* harmony import */ var _modules_modals_yb_video__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_modules_modals_yb_video__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _modules_modals_season_tickets__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modals/season-tickets */ "./js/modules/modals/season-tickets.js");
/* harmony import */ var _modules_modals_season_tickets__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_modals_season_tickets__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _modules_modals_trainers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modals/trainers */ "./js/modules/modals/trainers.js");
/* harmony import */ var _modules_modals_feedbacks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modals/feedbacks */ "./js/modules/modals/feedbacks.js");
/* harmony import */ var _modules_modals_connect_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/modals/connect-form */ "./js/modules/modals/connect-form.js");
/* harmony import */ var _modules_modals_connect_form__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_modals_connect_form__WEBPACK_IMPORTED_MODULE_5__);
...
/***/ "./js/modules/modals/connect-form.js":
/*!*******************************************!*\
  !*** ./js/modules/modals/connect-form.js ***!
  \*******************************************/
...
var checkExist = phoneField && nameField;
...
var checkPhoneMask = function checkPhoneMask(evt) {
  ...
  var clearValue = element.dataset.phoneClear;
  var pattern = element.dataset.phonePattern;
...
var removeErrorClass = function removeErrorClass(evt) {
  evt.target.classList.remove('input--error');
};
...
var activateValid = function activateValid() {
  if (nameField) {
    for (var _i2 = 0, _arr2 = ['input', 'blur']; _i2 < _arr2.length; _i2++) {
      var ev = _arr2[_i2];
...
/***/ "./js/modules/modals/feedbacks.js":
/*!****************************************!*\
  !*** ./js/modules/modals/feedbacks.js ***!
  \****************************************/
/*! no exports provided */
...
var feedbacksBox = document.querySelector('.feedbacks__wrap');
var feedbacksCards = document.querySelectorAll('.feedbacks__item');
var feedbacksButtons = document.querySelectorAll('.feedbacks__button');
var swiperFeedbacks = new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0___default.a('.feedbacks__list', {
  navigation: {
...
var activateFeedbacksSwiper = function activateFeedbacksSwiper() {
  if (swiperFeedbacks && feedbacksBox && feedbacksButtons.length) {
    feedbacksBox.classList.remove('feedbacks__wrap--nojs');
    feedbacksButtons.forEach(function (button) {
      return button.classList.remove('feedbacks__button--nojs');
    });
  }

  if (feedbacksBox && feedbacksCards.length) {
    feedbacksCards.forEach(function (card) {
      return card.classList.remove('feedbacks__item--nojs');
    });
  }
};

var observeFeedback = function observeFeedback(mutationsList) {
  mutationsList.forEach(function () {
    swiperFeedbacks.update();
  });
};

var observer = new MutationObserver(observeFeedback);
...
/***/ "./js/modules/modals/season-tickets.js":
/*!*********************************************!*\
  !*** ./js/modules/modals/season-tickets.js ***!
  \*********************************************/
/*! no static exports found */
...
var tabsContentBlocks = tabsBlock.querySelectorAll('.tabs__content');
var tabLinks = Array.from(document.querySelector('.tabs__links').children);

var onContentClick = function onContentClick(evt) {
  var card = evt.target.closest('li');
  var cardBox = Array.from(evt.target.closest('ul').children);
  cardBox.forEach(function (el) {
...
var onTabClick = function onTabClick(evt) {
  ...
  var linkWrap = evt.target.closest('li');
  var content = document.querySelector(id);
  var activeLink = linkWrap.querySelector('a');

  if (content) {
    tabLinks.forEach(function (linkBox) {
      var link = linkBox.querySelector('a');

      if (link.getAttribute('href') !== id) {
        var block = document.querySelector(link.getAttribute('href'));
...
var activateTabs = function activateTabs() {
  ...
  tabLinks.forEach(function (el) {
    return el.addEventListener('click', onTabClick);
  });
};
...
var trainersBox = document.querySelector('.trainers__wrap');
var trainersCards = document.querySelectorAll('.trainers__item');
var trainersButtons = document.querySelectorAll('.trainers__button');
var breakpointDesktop = window.matchMedia('(min-width:1200px)');
var swiperTrainers = new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0___default.a('.trainers__list', {
  navigation: {
  ...
  on: {
    init: function init() {
      var slidersWidth = this.params.spaceBetween * (this.loopedSlides - 1) + this.slidesSizesGrid[0] * this.loopedSlides;
...
var onCardClick = function onCardClick(evt) {
  var card = evt.target.closest('.trainers__item');

  if (card) {
    swiperTrainers.slides.forEach(function (el) {
...
var addTabIndexToSlide = function addTabIndexToSlide(evt) {
  if (evt.matches) {
    swiperTrainers.slides.forEach(function (slide) {
...
var activateTrainersSwiper = function activateTrainersSwiper() {
  if (swiperTrainers && trainersBox && trainersButtons.length) {
    trainersBox.classList.remove('trainers__wrap--nojs');
    trainersButtons.forEach(function (button) {
      return button.classList.remove('trainers__button--nojs');
    });
  }

  if (trainersBox && trainersCards.length) {
    trainersCards.forEach(function (card) {
      return card.classList.remove('trainers__item--nojs');
    });
  ...
  if (swiperTrainers) {
    swiperTrainers.slides.forEach(function (slide) {
      return slide.classList.remove('trainers__item--nojs');
    });
...
var videoBlock = document.querySelector('.yb-video');

var parseMediaURL = function parseMediaURL(link) {
...
var setupVideo = function setupVideo(video) {
  var linkBox = video.querySelector('.yb-video__link');
  var link = linkBox ? linkBox.querySelector('a') : null;
...
(function (global, factory) {
  ...
  function A11y(_ref) {
    ...
    on('beforeInit', function () {
      liveRegion = $("<span class=\"".concat(swiper.params.a11y.notificationClass, "\" aria-live=\"assertive\" aria-atomic=\"true\" style=\"opacity:0\"></span>"));
    });
